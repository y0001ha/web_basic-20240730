...
*/
console.log(10 / 3);
console.log('10' / 3); // 자동형변환 가능한거는 수행함
console.log('십' / 3);
console.log(10 / 0);
...
/*
    - + 단항 연산자는 숫자 타입이 아닌 피연산자에 사용하여 숫자 타입으로 반환 시킬수 있음
*/
...
/*
    ...
    - !== : 불일치 비교
*/
// 동등, 부등 비교는 자동형변환을 수행후 연산 진행 (데이터 타입 영향을 받지않음)
console.log(10 == '10'); 
