/*
    배열 : 여러가지 데이터를 하나의 변수에 저장하고자 할 때 사용
*/

/*
    배열 리터럴 : 
    - 0개 이상의 값을 쉼표로 구분하여 []에 묶어 표현
...
// newFruits[0] = '사과'; 
// console.log(newFruits, fruits);    //--> 얕은복사

// var newFruits = [];
// for (var index in fruits) {
//     newFruits[index] = fruits[index]; //--> 깊은복사
// }
...
/*
    ...
    - 배열의 요소를 제거하고 제거한 위치에요소를 갈아끼운 배열을 반환
*/
console.log(newFruits.splice(1,2, 'melon'), newFruits);
console.log(newFruits.splice(2,1), newFruits); //--> 중간에 제거를 하고 싶을때
