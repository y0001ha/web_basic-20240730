...
var mapArray = array.map(function (item) {
    return item * item;
});
console.log(mapArray);
...
console.log(mapArray);
// ar mapArray = array.map(function (_, index) item 안쓰고 싶을때 
// ar mapArray = array.map(function ($, index) 

// map으로 그대로 복사하는 방법
var newArray = array.map(function (item) {return item;});
console.log(newArray);

// map을 일반 for문으로 구성 -> 속도가 매우 빨라짐 , 동기처리 가능
// 1. 빈배열 생성
var newArray = [];
// 2. for문 작성
...
/*
    find(value, index) : 콜백 함수의 결과가 true인 첫번째 요소를 반환
*/
